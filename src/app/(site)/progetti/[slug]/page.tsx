  ...
  return (
    <div className="bg-white">
      ...
      <div className="page-px pt-[74px] md:pt-[100px] lg:pt-[120px] pb-[16px]">
        <div className="h-[32px] md:h-auto flex items-center justify-start text-xs md:text-sm leading-none text-black tracking-wide uppercase">
      ...
      <div className="hidden md:flex items-start justify-between page-px pt-[20px]">
        ...
        <Link
          href="/progetti"
          className="text-xs leading-[1.3] text-black hover:opacity-60 transition-opacity whitespace-nowrap mt-[16px] shrink-0"
        >
          Torna a progetti →
        </Link>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-[32px] gap-y-[24px] page-px pt-[16px] md:pt-[24px] pb-[24px] md:pb-[40px]">
        ...
        <div>
          <div className="text-xs leading-[1.3] text-black space-y-[4px]">
          ...
          <div className="hidden md:block">
            <div className="grid grid-cols-2 gap-[8px] mt-[24px] w-fit">
              ...
              <div className="flex flex-col gap-[6px]">
                <p className="text-xs leading-[1.3] text-black">Area</p>
                <div className="flex flex-wrap gap-[8px]">
                  {project.typology?.map((type) => (
                    <span key={type} className="inline-flex items-center border-[1.179px] border-black rounded-full px-[14px] py-[6px] text-[9.44px] text-black leading-[1.4] whitespace-nowrap">
                      {type}
                    </span>
                  ))}
                </div>
              ...
              {/* Stato column */}
              <div className="flex flex-col gap-[6px]">
                <p className="text-xs leading-[1.3] text-black">Stato</p>
                <div className="flex flex-wrap gap-[8px]">
                  <span className="inline-flex items-center border-[1.179px] border-black rounded-full px-[14px] py-[6px] text-[9.44px] text-black leading-[1.4] whitespace-nowrap">
                    {project.status}
                  </span>
                </div>
              </div>
            ...
            {project.teamMembers && project.teamMembers.length > 0 && (
              <div className="mt-[24px]">
                <p className="text-xs leading-[1.3] text-black mb-[6px]">Team</p>
                <div className="flex flex-wrap gap-[8px]">
                  {project.teamMembers.map((m) => (
                    <span key={m._id} className="text-xs leading-[1.3] text-black/60">{m.name}</span>
                  ))}
                </div>
              </div>
            )}
        ...
        <div>
          <div className="text-base md:text-[17.4px] leading-[1.4] md:leading-[1.2] text-black">
            {project.description ? (
          ...
          <div className="hidden md:flex items-center gap-[12px] pt-[32px]">
            <p className="text-xs font-semibold leading-[1.3] text-black">Condividi</p>
        ...
        <div className="md:hidden col-span-1">
          <div className="mb-[16px]">
            <p className="text-xs leading-[1.3] text-black mb-[8px]">Area</p>
            <div className="flex flex-wrap gap-[8px]">
              {project.typology?.map((type) => (
                <span key={type} className="inline-flex items-center border-[1.179px] border-black rounded-full px-[14px] py-[6px] text-[9.44px] text-black leading-[1.4] whitespace-nowrap">
                  {type}
          ...
          <div>
            <p className="text-xs leading-[1.3] text-black mb-[8px]">Stato</p>
            <div className="flex flex-wrap gap-[8px]">
              <span className="inline-flex items-center border-[1.179px] border-black rounded-full px-[14px] py-[6px] text-[9.44px] text-black leading-[1.4] whitespace-nowrap">
                {project.status}
              </span>
      ...
      <div className="page-px pb-12 pt-4 md:pt-0 md:flex md:justify-center">
        <Link
          href="/progetti"
          className="flex items-center justify-center w-full md:w-auto border-2 border-black rounded-full px-[24px] py-[10px] text-base text-black leading-[22px] hover:bg-black hover:text-white transition-colors duration-200"
        >
          Vai a tutti i progetti
        </Link>
      </div>
