    ...
    <div className="pt-[60px] md:pt-[80px]">
      <div className="page-px py-[40px] md:py-[60px]">
        ...
        <div className="max-w-[798px] text-base md:text-[17.5px] leading-[1.6] text-black space-y-6">
          <section>
            <h2 className="text-2xl font-semibold text-black mb-3">1. Introduzione</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-black mb-3">2. Dati che Raccogliamo</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-black mb-3">3. Come Utilizziamo i Tuoi Dati</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-black mb-3">4. Base Legale</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-black mb-3">5. Diritti dell'Utente</h2>
            <p>Hai diritto a:</p>
            <ul className="list-disc pl-6 mt-2 space-y-2">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-black mb-3">6. Contatti</h2>
            <p>
