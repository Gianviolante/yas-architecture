...
export default async function ProgettoPageV2({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="bg-white">
        ...
        <div className="flex-1">
          ...
          <div className="page-px md:p-0 pt-[24px] md:pt-[20px]">
            <div className="flex flex-col md:flex-row md:items-start md:justify-between md:gap-[40px] lg:gap-[60px]">
              <h1
                className="text-[48px] md:text-[60px] font-bold tracking-tight leading-[1.3] text-primary"
          ...
          <div className="page-px md:p-0 pt-[32px] md:pt-[40px] lg:pt-[60px] pb-[24px] md:pb-[40px] lg:pb-[60px]">
            <div
              className="text-[15px] md:text-[17px] leading-[1.8] md:leading-[1.8] text-primary"
      ...
      {/* ── Gallery slider (with two square images + lightbox) ──────── */}
      {galleryItems.length > 0 && (
        <GallerySection items={galleryItems.slice(2)} projectTitle={project.title} allGalleryItems={galleryItems} />
      )}
