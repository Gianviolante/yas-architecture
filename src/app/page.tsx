    ...
    <>
      ...
      <main className="flex-1">
        <div className="pt-[100px] md:pt-[120px]">
          ...
          <section className="hidden md:grid grid-cols-3 grid-rows-[auto_minmax(auto,280px)_minmax(80px,auto)] gap-y-[8px] lg:gap-y-[48px] gap-x-[32px] md:gap-x-[48px] lg:gap-x-[64px] overflow-hidden page-px md:py-[24px] lg:py-[32px]">
