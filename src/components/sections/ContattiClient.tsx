...
const PAESI = [...new Set([
  ...
  "Cile", "Cina", "Colombia", "Comore", "Corea del Nord", "Corea del Sud",
  ...
  "India", "Indonesia", "Irlanda del Nord",
  ...
  "Macao", "Madagascar", "Malawi", "Malesia", "Maldive", "Mali",
  ...
  "Niue", "Nuova Caledonia", "Nuova Zelanda", "Oman", "Pakistan", "Palau",
  "Palestina", "Panama", "Papua Nuova Guinea", "Paraguay", "Perù", "Polinesia Francese",
  "Puerto Rico", "Qatar", "Riunione",
  "Ruanda", "Sahara Occidentale", "Saint Barthelemy",
  "Saint Kitts e Nevis", "Saint Lucia", "Saint Martin", "Saint Pierre e Miquelon",
  "Saint Vincent e Grenadine", "Samoa", "Samoa Americane",
  "Sant'Elena", "Santa Lucia", "Senegal", "Seychelles", "Sierra Leone",
  "Siria", "Somali", "Sri Lanka", "Stati Uniti",
  "Stato della Palestina", "Stato della Vaticano", "Sud Sudan",
  "Sudan", "Tailandia", "Taiwan", "Tagikistan",
  ...
  "Turkmenistan", "Tuvalu", "Uganda", "Uguaglianza",
  "Unione Europea", "Uruguay", "Usa", "Uzbekistan", "Vanuatu",
